    ...
    <div className="min-h-screen bg-[#0d1a0e] flex flex-col items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-xl w-full text-center">
        ...
        <div className="flex items-center justify-center gap-3 mb-10">
          ...
          <span
            className="text-white/90 tracking-[0.25em] text-sm uppercase font-light"
        ...
        {status === "success" ? (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
            <input
              ...
              required
              className="flex-1 bg-white/5 border border-white/10 rounded-lg px-5 py-3.5 text-white placeholder-white/30 outline-none focus:border-[#7AA95C]/60 focus:bg-white/8 transition-all text-sm"
